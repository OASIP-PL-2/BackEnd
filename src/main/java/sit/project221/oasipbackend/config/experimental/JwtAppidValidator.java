package sit.project221.oasipbackend.config.experimental;
...
public final class JwtAppidValidator implements OAuth2TokenValidator<Jwt> {

	private final JwtClaimValidator<Object> validator;

	public JwtAppidValidator(String appid) {
		Assert.notNull(appid, "appid cannot be null");
		this.validator = new JwtClaimValidator<>("appid", claimPredicate(appid));
	}
